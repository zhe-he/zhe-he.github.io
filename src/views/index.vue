    ...
    <div class="ibody">
        ...
        <article class="main-l">
            ...
            <div class="bloglist">
                ...
                <div v-for="i in 1" :key="i" class="blogs">
                    ...
                    <p class="autor autor1"><span>作者：xx</span><span>分类：【<router-link :to="{name:'pageNew',params:{id:'123'}}">日记</router-link>】</span><span>浏览（<router-link :to="{name:'pageNew',params:{id:'123'}}">459</router-link>）</span><span>评论（<router-link :to="{name:'pageNew',params:{id:'123'}}">30</router-link>）</span></p>
        ...
        <aside class="main-r">
            ...
            <div class="tj_news">
                ...
                <common-article type="newArticle"></common-article>
            </div>
            <div class="links">
                <h2>
                    <p>友情链接</p>
                ...
                <ul>
                    <li><a href="/" target="black">xxx</a></li>
                    <li><a href="/" target="black">xxx</a></li>
                </ul>
            </div>
            <copyright></copyright>
